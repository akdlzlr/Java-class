...
public class GalleryController {
	...
	public void list(
		...
		@RequestParam(value="orderBy",defaultValue="gallery_id") String orderBy,Model model) throws Exception{
	...
	public String updateForm(@PathVariable long galleryId, Model model) throws Exception{
	...
	public String image(@PathVariable String mode, @PathVariable long imageId, Model model) throws Exception{
		...
		return "fileView";
		/* 두개를 합친게 위에 코드(image+thumb)
		@RequestMapping(value="/image/{imageId}", method=RequestMethod.GET)
		public String image(@PathVariable long imageId, Model model) throws Exception{
