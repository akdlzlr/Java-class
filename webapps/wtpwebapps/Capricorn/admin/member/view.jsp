...
<script>
	$(function() {
		$('#delete-btn').click(function(){
			// confirm 함수 예 아니오 로 입력받음?
			var result=confirm('${member.userId}삭제하시겠습니까?');
			if(result){
				//페이지 이동 객체
	...
	<div class="container">
		...
		<div>
			...
			<div class="row">
				...
				<div class="col-md-10">
					<fmt:formatDate value="${member.updateDate}" pattern="yyyy-MM-dd"></fmt:formatDate>
				</div>
			</div>
		</div>
		<div class="row mt-3">
			...
			<div class="col-md-10">
				<a href="javascript: history.back()" 
					class="btn btn-info"><i class="fas fa-clipboard-list"></i>목록</a>
